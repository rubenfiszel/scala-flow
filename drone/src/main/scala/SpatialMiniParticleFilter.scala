...
import spatial.dsl.{Matrix => _, _}
import dawn.flow.spatialf._
import dawn.flow.trajectory._
import dawn.flow.Source
import spatial.stdlib._
import org.virtualized._

case class SpatialMiniParticleFilter(s1: Source[Acceleration2D], s2: Source[Position2D], dt: scala.Double, N: scala.Int, covAcc: scala.Double, covGPS: scala.Double)
    extends SpatialBatchRaw2[Acceleration2D, Position2D, Position2D, SAcceleration2D, SPosition2D, SPosition2D](s1, s2) {
